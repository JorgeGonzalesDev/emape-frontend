...
const URL = `${baseURL}/TurnoLaboral`;


export const listTurnoLaboral = async () => {
  try {
...
export const getTurnoLaboral = async (id) => {
  try {
...
export const AddOrUpdateTurnoLaboral = async (body) => {
  try {
...
export const deleteTurnoLaboral = async (body) => {
  try {
