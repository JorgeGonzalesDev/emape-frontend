import { getPuestoLaboral,deletePuesto, AddOrUpdatePuesto } from "../../../service/labor/laborPuesto";
...
const LaborPuesto = () => {
    ...
    const destroy = async (event, cellValues) => {
        ...
        if (window.confirm(`Desea eliminar el registro con el id: ${cellValues.row.coD_PUESTO}?`)) {
        ...
        <>
            ...
            <div style={{ padding: '50px', display: 'flex', height: '100%' }}>
                <div style={{ flexGrow: 1 }}>
                    <DataGridDemo id={(row) => row.coD_PUESTO}
