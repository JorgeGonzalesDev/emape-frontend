import { getOcupacionLaboral,deleteOcupacion, AddOrUpdateOcupacion } from "../../../service/labor/laborposition";
...
const LaborPosition = () => {
    ...
    const destroy = async (event, cellValues) => {
        ...
        if (window.confirm(`Desea eliminar el registro con el id: ${cellValues.row.coD_OCUPLABORAL}?`)) {
        ...
        <>
            ...
            <div style={{ padding: '50px', display: 'flex', height: '100%' }}>
                <div style={{ flexGrow: 1 }}>
                    <DataGridDemo id={(row) => row.coD_OCUPLABORAL}
